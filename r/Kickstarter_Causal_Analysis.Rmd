...
treatment_counts$Treatment <- c('Control','One Dollar Reward','Project We Love','Previous Experience')
...
library(wesanderson)
g <- ggplot(data=treatment_counts, aes(x=Treatment,y=SUCCESS_RATE)) + geom_bar(stat = 'Identity',aes(fill=Treatment)) +
